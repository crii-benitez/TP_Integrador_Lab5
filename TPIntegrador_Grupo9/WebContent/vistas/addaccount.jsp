...
<body>
	...
	<div class="bg-lingh">
		<div class="container table py-4">
		<h1 class="col-12 col-xl-8 h3 text-left text-primary pt-3">Listado de Cuenta</h1>
			<table id="example" class="container table table-striped table-bordered">
			        ...
			        <tbody>
			            <tr>
			                ...
			                <td>Caja de ahorro común - Pesos</td>
			                <td>61</td>
			                <td>2012/12/02</td>
			                <td>$37200,000</td>
			            ...
			            <tr>
			                ...
			                <td>Integration Specialist</td>
			                <td>Caja de ahorro común - Dolares</td>
			                <td>55</td>
			                <td>2010/10/14</td>
			                <td>$32007,900</td>
			                <td><button type="button" class="btn btn-primary"><i class="fas fa-edit"></i></button>
			            ...
			            <tr>
			                ...
			                <td>Caja de ahorro común - Pesosk</td>
			                <td>59</td>
			                <td>2009/04/10</td>
			                <td>$237000,500</td>
			                <td><button type="button" class="btn btn-primary"><i class="fas fa-edit"></i></button>
